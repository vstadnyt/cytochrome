...
def _fig4():
    ...
    fig.suptitle('Population distribution of proteins', fontsize=14, fontweight='bold')
    ...
    plt.xticks(range(11),  ['0', '1', '2', '3','4','','6','','8','','10'] ) 
    plt.axvline(x=1, linestyle='--')
    plt.axvline(x=2, linestyle='--')
    plt.axvline(x=3, linestyle='--')
    ax1.text(0.56, 0.95, r'$i$', fontsize=15)
    ax1.text(1.55, 0.95, r'$ii$', fontsize=15)
    ax1.text(2.5, 0.95, r'$iii$', fontsize=15)
    plt.title("")
    ...
    plt.plot(population[:,2000],'--o')
    plt.plot(population[:,3000],'--o')
    ax2.text(0.5, 0.34, r'$i$', fontsize=15)
    ax2.text(0.5, 0.17, r'$ii$', fontsize=15)
    ax2.text(0.5, 0.07, r'$iii$', fontsize=15)
    plt.legend(['t=1$\cdot$1/k','t= 2$\cdot$1/k','t=3$\cdot$1/k'])
    plt.xlabel('Oxidation state (# of electrons)')
    plt.ylabel('Population')
    plt.savefig('popultions_of_N_states_at_diff_t.jpg')
    plt.xticks(range(5),  ['0', '1', '2', '3','4'] ) 
    ax1.text(9.5, 0.85, r'$A$', fontsize=18)
    ax2.text(3.75, 0.25, r'$B$', fontsize=18)
    plt.show()
    plt.show()
...
def _fig12():
    ...
    plt.xticks(range(11),  ['0', '', '2', '','4','','6','','8','','10'] ) 
    plt.legend(['$OD$','$CD_{nn}$','$CD_{np}$'])
    plt.xlabel('1/k, seconds')
